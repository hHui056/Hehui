...
public class StorageClient1 extends StorageClient {
     ...
     * @param file_ext_name
     *            file ext name, do not include dot(.), null to extract ext name from the local filename
     * @param meta_list
     *            meta info array
    ...
    public String upload_file1_with_check(String group_name, long file_size, UploadCallback callback, String file_ext_name, NameValuePair[] meta_list, Map<String, Object> params) throws IOException, MyException {
        String parts[] = this.upload_file_with_check(group_name, file_size, callback, file_ext_name, meta_list, params);
        if (parts != null) {
            return parts[0] + SPLIT_GROUP_NAME_AND_FILENAME_SEPERATOR + parts[1];
        } else {
            return null;
    ...
    public int delete_file1_with_check(String file_id, Map<String, Object> params) throws IOException, MyException {
        String[] parts = new String[2];
        this.errno = StorageClient1.split_file_id(file_id, parts);
        if (this.errno != 0) {
            return this.errno;
        ...
        return this.delete_file_with_check(parts[0], parts[1], params);
    }
    ...
    public int download_file1_with_check(String file_id, String local_filename, Map<String, Object> params) throws IOException, MyException {
        final long file_offset = 0;
        final long download_bytes = 0;

        return this.download_file1_with_check(file_id, file_offset, download_bytes, local_filename, params);
    }
    ...
    public int download_file1_with_check(String file_id, long file_offset, long download_bytes, String local_filename, Map<String, Object> params) throws IOException, MyException {
        String[] parts = new String[2];
        this.errno = StorageClient1.split_file_id(file_id, parts);
        if (this.errno != 0) {
            return this.errno;
        ...
        return this.download_file_with_check(parts[0], parts[1], file_offset, download_bytes, local_filename, params);
    }
     ...
     *            the file id(including group name and filename)
     * @param callback
     *            the callback object, will call callback.recv() when data arrive
     * @return 0 success, return none zero errno if fail
     */
    ...
    public int download_file1_with_check(String file_id, DownloadCallback callback, Map<String, Object> params) throws IOException, MyException {
        final long file_offset = 0;
        final long download_bytes = 0;

        return this.download_file1_with_check(file_id, file_offset, download_bytes, callback, params);
    }
    ...
    public int download_file1_with_check(String file_id, long file_offset, long download_bytes, DownloadCallback callback, Map<String, Object> params) throws IOException, MyException {
        String[] parts = new String[2];
        this.errno = StorageClient1.split_file_id(file_id, parts);
        if (this.errno != 0) {
            return this.errno;
        ...
        return this.download_file(parts[0], parts[1], file_offset, download_bytes, callback, params);
    }
     ...
     *            </ul>
     *            <ul>
     *            <li>ProtoCommon.STORAGE_SET_METADATA_FLAG_MERGE: merge, insert when the metadata item not exist, otherwise update it</li>
     *            </ul>
