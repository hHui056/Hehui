...
public class Base64 {
	...
	/**
	 * Encode an arbitrary array of bytes as Base64 printable ASCII. It will be broken into lines of 72 chars each. The last line is not terminated with a line separator. The
	 * output will always have an even multiple of data characters, exclusive of \n. It is padded out with =.
	 */
	...
	public static void main(String[] args) {
		...
		if (debug) {
			...
			/*
			 * byte[] a = { (byte)0xfc, (byte)0x0f, (byte)0xc0}; byte[] b = { (byte)0x03, (byte)0xf0, (byte)0x3f}; byte[] c = { (byte)0x00, (byte)0x00, (byte)0x00}; byte[] d = {
			 * (byte)0xff, (byte)0xff, (byte)0xff}; byte[] e = { (byte)0xfc, (byte)0x0f, (byte)0xc0, (byte)1}; byte[] f = { (byte)0xfc, (byte)0x0f, (byte)0xc0, (byte)1, (byte)2};
			 * byte[] g = { (byte)0xfc, (byte)0x0f, (byte)0xc0, (byte)1, (byte)2, (byte)3}; byte[] h = "AAAAAAAAAAB".getBytes();
			 * 
			 * 
			 * 
			 * show(a); show(b); show(c); show(d); show(e); show(f); show(g); show(h); Base64 b64 = new Base64(); show(b64.decode(b64.encode(a))); show(b64.decode(b64.encode(b)));
			 * show(b64.decode(b64.encode(c))); show(b64.decode(b64.encode(d))); show(b64.decode(b64.encode(e))); show(b64.decode(b64.encode(f))); show(b64.decode(b64.encode(g)));
			 * show(b64.decode(b64.encode(h))); b64.setLineLength(8); show((b64.encode(h)).getBytes());
			 */
		}
	}// end main
